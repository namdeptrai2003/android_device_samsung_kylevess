...
# Recovery
TARGET_RECOVERY_FSTAB := device/samsung/kylevess/ramdisk/recovery/recovery.fstab
TARGET_RECOVERY_INITRC := device/samsung/kylevess/ramdisk/recovery/init.rc
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/samsung/kylevess/ramdisk/recovery/recovery_keys.c
